-- ============================================================================
-- DayMax — migration 0036: Budget Baddies
--
--   * "30 Days, Less Spent" becomes "Budget Baddies", ranked on DOLLARS
--   * income baseline you can set, defaulting to your last income before the
--     start date (a monthly salary paid on the 1st is the right denominator
--     for a challenge starting on the 15th)
--   * richer standings: per-day pace, biggest category, essential split
--   * challenge_daily() and challenge_categories() for the charts
--   * invite friends in-app, with an invitation they accept
--
-- Run AFTER 0033-0035. Wrapped in a transaction.
-- ============================================================================
...
-- select name, metric, starts_on, ends_on from public.challenges;
-- select * from public.challenge_standings('66666666-0000-4000-8000-000000000001');
