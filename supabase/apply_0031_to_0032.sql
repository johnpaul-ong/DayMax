-- ============================================================================
-- DayMax — migrations 0031 and 0032
--
-- You have already run everything up to and including 0030. These are the new
-- ones. Wrapped in a transaction: if anything fails, nothing changes.
--
--   0031  team colours on every name, honest Arena scopes, default lift,
--         bodyweight on profiles, member lists on all pursuits
--   0032  delete-my-account
-- ============================================================================
...
-- ==========================================================================
-- 0031_teams_scopes_defaults.sql
-- ==========================================================================
