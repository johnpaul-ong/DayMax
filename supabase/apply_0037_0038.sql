-- ============================================================================
-- DayMax — apply 0037 + 0038 together
--
--   0037  the iOS theme (widens the profiles.theme CHECK constraint; without
--         it, choosing iOS saves silently fails — saveThemeToAccount swallows
--         the error, so the theme works on-device and never syncs)
--   0038  flexible challenges: metric / direction / stat_id, ten rankable
--         metrics, and metric-aware standings, daily and categories functions
--
-- Wrapped in one transaction so a failure rolls the whole thing back rather
-- than leaving the database half-migrated. Paste into the Supabase SQL editor.
-- Run AFTER 0033-0036.
-- ============================================================================
