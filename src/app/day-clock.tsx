...
export default function DayClock({
  ...
  maxWidth?: number;
  /**
   * Unused today (the fullscreen expand overlay was removed on
   * feedback), kept as a hook so a future in-place zoom mode can
   * suppress the card chrome without ripping the prop back out.
   */
  _fullscreen?: boolean;
}) {
