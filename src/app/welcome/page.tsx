      ...
      <div className="card space-y-4 p-5">
        ...
        {step === 2 && (
          <>
            ...
            <p className="-mt-2 text-sm text-muted">
              Your theme is your team. Every pursuit keeps score of Light vs Midnight vs Cottage vs iOS, so this is the
              only tribal decision you have to make. Changes as you tap.
            </p>
